...
const Gallery = () => {
  ...
  return (
    ...
    <img src={cypress} alt="background-image-cypress" className="mt-16"/>
      <div className="bg-black relative border-2 border-white bg-opacity-65 p-4 rounded-xl mx-4 md:mx-10 lg:mx-16 -mt-40 xsm:-mt-[19rem] sm:-mt-[27rem] md:-mt-[33rem] lg:-mt-[46rem] xl:-mt-[59rem] 2xl:-mt-[72rem] 3xl:-mt-[86rem] 4xl:-mt-[122rem] mb-14 h-3/4 flex justify-center items-center flex-col">
        <h1 className="text-white font-thin text-9xl lg:text-[10rem] font-madi -mt-20 gallery absolute -top-1">Gallery</h1>
        <div className="overflow-hidden font-semibold font-raleway mt-20 lg:mt-24 mb-5 flex flex-col sm:flex-row gap-10 sm:items-start">
          <motion.div
          initial = {{ opacity: 0}}
          animate = {{opacity: 1}}
          ...
          className="relative sm:w-[170%]">
            ...
            <div className="bg-black flex opacity-100 xl:opacity-0 bg-opacity-15 absolute top-0 bottom-1 w-full hover:opacity-100 transition-all duration-500 justify-center items-end rounded-lg">
              <p className="w-full text-center text-3xl 4xl:text-6xl mx-0.5 text-white bg-black py-1 rounded-sm bg-opacity-65 gallery">PAINTINGS</p>
            </div>
            </Link>
          </motion.div>
          <motion.div
          ...
          className="relative sm:w-[160%]">
            ...
            <div className="bg-black flex opacity-100 xl:opacity-0 bg-opacity-15 absolute top-0 bottom-1 w-full hover:opacity-100 transition-all duration-500 justify-center items-end rounded-lg">
              <p className="w-full text-center text-3xl 4xl:text-6xl mx-0.5 text-white bg-black py-1 rounded-sm bg-opacity-65 gallery">CRAFTS</p>
            </div>
            </Link>
          </motion.div>
          <motion.div
          ...
          className="relative sm:w-[160%]">
            ...
            <div className="bg-black shadow-md shadow-green-300 flex opacity-100 xl:opacity-0 bg-opacity-15 absolute top-0 bottom-1 w-full hover:opacity-100 transition-all duration-500 justify-center items-end rounded-lg">
              <p className="w-full text-center text-3xl 4xl:text-6xl mx-0.5 text-white border-b-2 bg-black py-1 rounded-sm bg-opacity-65 gallery">FLORA</p>
            </div>
            </Link>
          </motion.div>
        </div>
