...
const Gallery = () => {
  ...
  return (
    ...
    <img src={cypress} alt="background-image-cypress" className="mt-16"/>
      <div className="bg-black relative border-2 border-white bg-opacity-65 p-4 rounded-xl mx-4 md:mx-10 lg:mx-16 -mt-40 xsm:-mt-[19rem] sm:-mt-[27rem] md:-mt-[34rem] lg:-mt-[46rem] xl:-mt-[59rem] 2xl:-mt-[72rem] 3xl:-mt-[86rem] 4xl:-mt-[103rem] mb-14 h-3/4 flex justify-center items-center flex-col">
