...
const Gallery = () => {
  return (
    ...
    <img src={cypress} className="mt-16"/>
      <div className="bg-black relative border-2 border-white bg-opacity-65 p-4 rounded-xl mx-4 md:mx-10 lg:mx-16 -mt-40 sm:-mt-[30rem] lg:-mt-[40rem] xl:-mt-[53rem] mb-14 h-3/4 flex justify-center items-center flex-col">
        ...
        <div className="overflow-hidden font-semibold font-raleway mt-20 mb-5 flex flex-col sm:flex-row gap-10 sm:items-start">
          ...
          className="relative sm:w-[170%]">
            <img src={gal1} className="rounded-md border-2 shadow-md shadow-green-300"/>
            <Link to="/about">
