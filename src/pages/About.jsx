...
const About = () => {
  return (
    ...
    <div className="bg-[#0E2751] h-full flex flex-col justify-center sm:pb-16">
    <img src={starry} className="mt-16"/>
      <div className="bg-black relative border-2 border-white bg-opacity-65 p-4 rounded-xl m-2  lg:mx-16 -mt-16 sm:-mt-56 lg:-mt-[35rem] mb-14 h-3/4 flex justify-center items-center flex-col">
          ...
          className="text-white text-xl sm:text-2xl overflow-hidden mt-12 mb-6 lg:mb-20 text-center font-raleway font-semibold sm:px-2 lg:px-20">
