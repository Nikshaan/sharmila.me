...
const About = () => {
  ...
  return (
    ...
    <div className="bg-gradient-to-b from-black to-[#14014f] text-white mt-16 pt-10 h-full flex flex-col justify-center items-center sm:pb-5 overflow-hidden">
          <h1 className="border-b-2 border-[#6fb3f2] text-8xl lg:text-9xl 2xl:text-[10rem] font-domine">ABOUT</h1>
          ...
          <p className="text-xl sm:text-2xl overflow-hidden mt-8 text-center font-raleway font-bold px-8 sm:px-2 lg:px-10 xl:px-16">
          ...
          <p className="text-xl sm:text-2xl overflow-hidden mt-8 text-center font-raleway font-medium px-8 sm:px-2 lg:px-10 xl:px-16">
