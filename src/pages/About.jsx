...
const About = () => {
  ...
  return (
    <div className="relative pb-80 min-w-[390px] min-h-[100svh] h-full bg-gradient-to-b from-black to-[#14014f] text-white">
    ...
    <div className="mt-10 pt-14 lg:pt-[7.5rem] h-full flex flex-col justify-center items-center sm:pb-5 overflow-hidden">
        ...
        <p className="text-xl sm:text-2xl 2xl:text-3xl overflow-hidden mt-8 text-center font-raleway font-medium px-8 sm:px-2 lg:px-10 xl:px-16">
        ...
        <p className="text-xl sm:text-2xl 2xl:text-3xl overflow-hidden mt-8 text-center font-raleway font px-8 sm:px-2 lg:px-10 xl:px-16">
