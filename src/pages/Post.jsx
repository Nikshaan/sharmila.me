  ...
  return (
    <div className="text-white">
        ...
        <div className="w-full mt-16 relative text-center font-raleway">
            ...
            <div className="absolute top-0 bottom-0 flex flex-col bg-black bg-opacity-45 justify-center items-center w-full p-2">
            ...
            <div className="flex justify-between items-center px-2 gap-4  text-lg sm:text-2xl lg:text-3xl">
                <p className="font-thin">{currPost.time} read</p>
                <p className="font-thin">Posted on {currPost.date}</p>
            </div>
        </div>
