...
const Journal = () => {
  return (
    ...
    <img src={mit} alt="background-image-mit" className="mt-16"/>
      <div className="bg-black relative border-2 border-white bg-opacity-65 p-4 rounded-xl mx-4 md:mx-10 lg:mx-16 -mt-32 sm:-mt-[24rem] md:-mt-[30rem] lg:-mt-[41rem] xl:-mt-[53rem] 2xl:-mt-[64rem] 3xl:-mt-[78rem] 4xl:-mt-[92rem] mb-14 h-screen flex justify-start items-center flex-col">
