...
const PaintingPage = () => {
  ...
  return (
    <div className="w-full m-auto h-full flex flex-col items-center">
        ...
        <div className="flex flex-col lg:flex-row w-[80%] 2xl:w-[70%] 4xl:w-[60%] m-auto justify-center items-center lg:pt-40 lg:items-start lg:justify-between gap-10 text-white h-full py-20">
            <img src={SLIDES[paintingID]} className="w-full border-2 p-1 lg:w-1/2"/>
            <div className="w-full h-full flex flex-col items-start justify-start gap-2 font-raleway font-light lg:mt-0 -mt-4">
                ...
                <p className=" my-1 text-sm 2xl:text-base border-2 px-3 py-1 bg-white bg-opacity-15 rounded-full">{paintingsDesc[paintingID].available === true?`AVAILABLE`:`UNAVAILABLE`}</p>
                <p className="text-base font-raleway font-thin sm:text-lg">{paintingsDesc[paintingID].longDesc?`${paintingsDesc[paintingID].longDesc}`: paintingsDesc[paintingID].shortDesc?`${paintingsDesc[paintingID].shortDesc}`:null}</p>
            </div>
        </div>
