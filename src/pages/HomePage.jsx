...
const HomePage = () => {
  ...
  return (
    <div className="bg-white w-full min-w-[344px] min-h-[100svh] sm:max-h-[100svh] h-full overflow-hidden flex-col justify-center items-center text-black">  
      <div className="absolute top-0 right-0 left-0 transition-all duration-200 z-40">
        <Navbar />
      </div>
      <div className="flex flex-col md:flex-row w-[85%] min-h-[100svh] md:items-center md:justify-center md:gap-10 md:pt-32 pt-16 m-auto bg-white pb-12 md:pb-40">
        <motion.div
        initial = {{ x: "-200vh"}}
        animate = {{x: 0}}
        ...
        transition={{ duration: 2, ease: "easeInOut" }}
        exit={{ x: "200vh" }} 
        className="bg-white w-full md:w-1/2 2xl:w-[40%] 3xl:w-[35%]">     
        <Fade scale={0.4} arrows={false}>
