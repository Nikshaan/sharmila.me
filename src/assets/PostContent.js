import alice from "../assets/PostImg/alice.jpg"
import scarlet from "../assets/PostImg/scarlet.jpeg"
import wizard from "../assets/PostImg/wizard.jpg"
import earth from "../assets/PostImg/earth.jpg"
import moby from "../assets/PostImg/moby.png"
import world from "../assets/PostImg/world.jpg"
...
export const PostContent = [
    {
        ...
        time: "4 minutes",
        date: "March 25, 2016",
        content: "<p>The rabbit-hole went straight on like a tunnel for some way, and then dipped suddenly down, so suddenly that Alice had not a moment to think about stopping herself before she found herself falling down a very deep well.</p>" + 
    ...
    },
    {
        ...
        "<p>'It's red,' Edwin answered the question. 'And you don't know it because  you come from the Chauffeur Tribe. They never did know nothing, none of  them. Scarlet is red—I know that.'</p>" +
    ...
    },
    {
        ...
        time: "1 minute",
        date: "March 15, 2016",
        content: "<p>Now this same morning the Wicked Witch came to the door of her castle and looked out with her one eye that could see far off. She saw all her wolves lying dead, and the strangers still traveling through her country. This made her angrier than before, and she blew her silver whistle twice.</p>" + 
    ...
    },
    {
        ...
        time: "4 minutes",
        date: "March 5, 2016",
        content: "<p>Nearly all joined in singing this hymn, which swelled high above the howling of the storm. A brief pause ensued; the preacher slowly turned over the leaves of the Bible, and at last, folding his hand down upon the proper page, said: 'Beloved shipmates, clinch the last verse of the first chapter of Jonah—'And God had prepared a great fish to swallow up Jonah.''</p>" + 
        "<p>'Shipmates, this book, containing only four chapters—four yarns—is one of the smallest strands in the mighty cable of the Scriptures. Yet what depths of the soul does Jonah's deep sealine sound! what a pregnant lesson to us is this prophet! What a noble thing is that canticle in the fish's belly! How billow-like and boisterously grand! We feel the floods surging over us; we sound with him to the kelpy bottom of the waters; sea-weed and all the slime of the sea is about us! But WHAT is this lesson that the book of Jonah teaches? Shipmates, it is a two-stranded lesson; a lesson to us all as sinful men, and a lesson to me as a pilot of the living God. As sinful men, it is a lesson to us all, because it is a story of the sin, hard-heartedness, suddenly awakened fears, the swift punishment, repentance, prayers, and finally the deliverance and joy of Jonah. As with all sinners among men, the sin of this son of Amittai was in his wilful disobedience of the command of God—never mind now what that command was, or how conveyed—which he found a hard command. But all the things that God would have us do are hard for us to do—remember that—and hence, he oftener commands us than endeavors to persuade. And if we obey God, we must disobey ourselves; and it is in this disobeying ourselves, wherein the hardness of obeying God consists.</p>" +
    ...
    },
    {
        ...
        time: "1 minute",
        date: "March 1, 2016",
        content: "<p>'You're a sly dog!' said Passepartout, winking at him.</p>" + 
        ...
        "<p>'Why,'responded Fix, a little embarrassed, 'I don't know; perhaps—'</p>" +
