  ...
  return (
    <div className="bg-black pt-10 font-raleway text-white flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center p-3">
            <p className="text-center font-semibold px-3">SUBSCRIBE TO RECEIVE POSTS DIRECTLY TO YOUR INBOX</p>
            <div className="flex w-full px-4 gap-4 justify-center items-center mt-4">
        ...
        <div className="mb-10">
            <p className="font-thin">Copyright © Sharmila Sharma 2024</p>
        </div>
    </div>
  )
}
