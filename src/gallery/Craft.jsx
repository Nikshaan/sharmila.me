  ...
  return (
    <div className="w-full xsm:w-[80%] 2xl:w-[70%] 4xl:w-[60%] m-auto h-full bg-transparent">
        ...
        <div className="pt-8 pb-4 w-full flex flex-col justify-center items-center">
            <h1 className="text-center text-5xl lg:text-5xl font-manrope pt-12 border-b-2 border-[#f23a11]">CRAFT</h1>
        </div>

        <div className="h-full">
            <div className="w-full text-black mb-4 h-14 flex justify-end items-center border-2 bg-[#ebeef0] border-black px-4 font-raleway">
