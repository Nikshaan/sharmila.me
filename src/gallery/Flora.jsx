  ...
  return (
    <div className="w-[80%] 2xl:w-[70%] 4xl:w-[60%] m-auto h-full bg-transparent">
        ...
        <div className="pt-16 pb-4 w-full flex flex-col justify-center items-center">
            <h1 className="text-center text-6xl lg:text-8xl pt-12 font-manrope text-[#0f1b61]">FLORA</h1>
        </div>

        <div className="h-full">
            <div className="w-full text-black border-[#0f1b61] h-14 flex justify-end items-center border-2 px-4 bg-[#6fb3f2] font-raleway">
